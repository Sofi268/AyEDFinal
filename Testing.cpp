...
//     routers = rout;
//     caminoAnt = paquete->getCamino();
//     proximo = basePartida;
//     if(paquete->getCamino().size() == 1) ultimoRouter = true;
//     else ultimoRouter = false;
//     sigRouter = caminoAnt.cabeza();
//     caminoAux = new Lista<int>();
//     if(!ultimoRouter){
//         actualizacionMatriz();
//         setCamino(paquete);
//     }
...
//     int routerBase = basePartida->getID();
//     int routDestino = paquete->getRouterFinal();
//     pdist = dijkstra(matriz, routerBase, routDestino, P);
//     if(pdist[routDestino]!=INFI){
//         cout<<"\n\n distancia minima del nodo "<<s
//             <<" al nodo "<<t<<" es= "<<pdist[routDestino];
//         cout<<"\n\n CAMINO= ";
//         caminoAux = caminoAux->resto();
//         paquete->setNuevoCamino(*caminoAux);
//     }                
//     else cout<<"\n NO HAY CAMINO";
...
// void Camino::actualizacionMatriz()
// {
//     int routActual = paq->getRoutActual();
//     for(int i = 0; i<cantidadRouters; i++){
//         for(int j = 0; j<cantidadRouters; j++){
//             if(matriz[i][j]!=INFI){
//                 if((j!=routActual)&&(i!=routActual)){
//                     int peso = buscarRouter(i, routers)->turno(j);
//                     matriz[i][j] = peso;
//                 }
//             }
//         }
